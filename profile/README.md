...
| 단계 | 화면 |
|---|---|
| **이슈 탐색 홈** — 날짜별 지표, 이어서 할 일, 오늘의 사설 | ![이슈 탐색 홈](images/03-이슈탐색홈.png) |
| **최근 사설** — 네이버 뉴스 검색 통과 조회(9개 매체), 원문 링크 | ![최근 사설](images/04-최근사설.png) |
| **발췌 담기** — 주장/사실 구분 입력, 구절당 최대 1,000자 | ![발췌 담기](images/05-발췌담기.png) |
| **발췌함** — 발췌를 묶어 이슈 생성, 매체당 1,200자 한도 표시 | ![발췌함](images/06-발췌함.png) |
| **이슈 상세** — 진행 단계, 사건 정리(해석 배제), 진영별 발췌 | ![이슈 상세](images/07-이슈상세.png) |
| **워크스페이스** — 좌: 근거 발췌 / 중: 초안 에디터 / 우: 근거 원문 대조 | ![워크스페이스](images/08-워크스페이스.png) |
| **검토 패널** — 인용 원문 대조, 인용 총량 검사, 발행 | ![검토 패널](images/09-검토패널.png) |
| **내 작업** — 작성·검토·발행 달력, 날짜별 상세, 메모 | ![내 작업](images/10-내작업.png) |
...
![품질 개선 순환](images/quality-loop.svg)
